...
async function handleSearch(event) {
    if (event.key === "Enter") {
        ...
        if (resultMovie.Response === "True") { // if the movie was found
                    ...
                    <div class="col-md-7 m-2">
                        <div class="card-body d-flex flex-column justify-content-around align-items-around h-100">
                            ...
                            <span class="card-text d-flex flex-column justify-content-center">
                                <p class="release-date text-muted fs-4">
                                    ${resultMovie.Year}
                                </p>
                                <p class="actors text-muted fs-4"> ${resultMovie.Actors} </p>
            ...
            document.getElementById("doc-text").innerHTML = "Movie not found! <br> Try again"
        }
